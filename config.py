...
if mode == "train":
    ...
    pretrained_model_weights_path = "./results/pretrained_models/SqueezeNet-ImageNet_1K-145ddc1c.pth.tar"
...
if mode == "test":
    ...
    model_weights_path = "./results/pretrained_models/SqueezeNet-ImageNet_1K-145ddc1c.pth.tar"
